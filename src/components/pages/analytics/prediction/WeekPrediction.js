...
/**
 * WeekPrediction component renders prediction page for week timespan
 */
            ...
            <Card className="mt-3">
              <Card.Body>
                ...
                <ListGroup variant="flush">
                  <ListGroup.Item>
                    Marathon (26.2 miles):{" "}
                    {getPrediction(this.props.runs, 7, "days", "MM-DD", 26.2)}
                  </ListGroup.Item>
                  <ListGroup.Item>
                    Half Marathon (13.1 miles):{" "}
                    {getPrediction(this.props.runs, 7, "days", "MM-DD", 13.1)}
                  </ListGroup.Item>
                  <ListGroup.Item>
                    20K (12.427 miles):{" "}
                    {getPrediction(this.props.runs, 7, "days", "MM-DD", 12.427)}
                  </ListGroup.Item>
                  <ListGroup.Item>
                    15K (9.321 miles):{" "}
                    {getPrediction(this.props.runs, 7, "days", "MM-DD", 9.321)}
                  </ListGroup.Item>
                  <ListGroup.Item>
                    10K (6.214 miles):{" "}
                    {getPrediction(this.props.runs, 7, "days", "MM-DD", 6.214)}{" "}
                  </ListGroup.Item>
                  <ListGroup.Item>
                    5K (3.107 miles):{" "}
                    {getPrediction(this.props.runs, 7, "days", "MM-DD", 3.107)}{" "}
                  </ListGroup.Item>
                </ListGroup>
              </Card.Body>
            </Card>
...
export default connect(mapStateToProps)(WeekPrediction);
