...
/**
 * YearAverage component renders prediction page for year timespan
 */

class YearPrediction extends Component {
  constructor(props) {
    super(props);
...
export default connect(mapStateToProps)(YearPrediction);
